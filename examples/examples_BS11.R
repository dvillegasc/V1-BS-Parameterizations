#Verificacion de la dBS11

integrate(dBS11, lower=0, upper=999, mu=1.5, sigma=1.5)
...
dldm_compu <- function(y, mu, sigma) {
  ...
  dm <- gamlss::numeric.deriv(
    expr = dBS11(y, mu, sigma, log = TRUE), 
    theta = "mu",                           
    delta = 1e-04)
...
y <- rBS11(n=n, mu=true_mu, sigma=true_si)

library(gamlss)
mod <- gamlss(y ~ 1, family=BS11,
              n.cyc = 100)
...
curve(dBS11(x, mu = 1, sigma= 0.5), from = 0.0000001, to = 2.5,
      ylim = c(0, 1.5),
      col = "black",        
      lwd = 2,              
      las = 1,
...
curve(dBS11(x, mu = 1, sigma= 1), add = TRUE, col = "black", type= "l", lty=2, lwd = 2)

curve(dBS11(x, mu = 1, sigma= 2), add = TRUE, col = "black", type= "l", lty=3, lwd = 2)

curve(dBS11(x, mu = 1, sigma= 5), add = TRUE, col = "gray", type= "l", lty=1, lwd = 2)

curve(dBS11(x, mu = 1, sigma= 10), add = TRUE, col = "gray", type= "l", lty=2, lwd = 2)

curve(dBS11(x, mu = 1, sigma= 12), add = TRUE, col = "gray", type= "l", lty=3, lwd = 2)
...
legend("topright",
       ...
       bty="n",
       cex = 0.9,        
       legend = c("ω = 0.5", "ω = 1", "ω = 2", "ω = 5", "ω = 10", "ω = 12"))


#------------------------ Grafica 2 ------------------------------------


curve(dBS11(x, mu = 0.75, sigma= 5), from = 0.25, to = 2.75,
      ylim = c(0, 1.5),
      col = "black",        
      lwd = 2,              
      las = 1,
...
curve(dBS11(x, mu = 0.95, sigma= 5), add = TRUE, col = "black", type= "l", lty=2, lwd = 2)

curve(dBS11(x, mu = 1, sigma= 5), add = TRUE, col = "black", type= "l", lty=3, lwd = 2)

curve(dBS11(x, mu = 1.15, sigma= 5), add = TRUE, col = "gray", type= "l", lty=1, lwd = 2)

curve(dBS11(x, mu = 1.25, sigma= 5), add = TRUE, col = "gray", type= "l", lty=2, lwd = 2)

curve(dBS11(x, mu = 1.5, sigma= 5), add = TRUE, col = "gray", type= "l", lty=3, lwd = 2)
...
var_values <- varBS11(mu = mu1, sigma = sigma1)
