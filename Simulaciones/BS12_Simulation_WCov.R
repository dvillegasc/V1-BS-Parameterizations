...
parSim(
  ...
  name = "C:/Users/davil/Desktop/BS-Parametrizations/Simulaciones/Simuls/BS12_Sim_WCov",  # Name of the file
  nCores = 6,                                 # Number of cores to use
  progressbar = TRUE,               # Progress bar
  export = c("dBS", "pBS", "qBS", "rBS", "hBS", "dBS12", "pBS12", "qBS12", "rBS12", "hBS12", "BS12"),
  ...
  expression = {
    ...
    y <- rBS12(n=n, mu, sigma)
    
    f   <- y ~ 1
    mod <- try(suppressMessages(gamlss2(f, family=BS12)), silent = TRUE)
...
archivos <- list.files(pattern = "^BS12_Sim_WCov.*\\.txt$", 
...
ggsave(filename="C:/Users/davil/Desktop/BS-Parametrizations/Simulaciones/Figs/bias_BS12_Sim_WCov.pdf", width=12, height=6,
...
ggsave(filename="C:/Users/davil/Desktop/BS-Parametrizations/Simulaciones/Figs/mse_BS12_Sim_WCov.pdf", width=12, height=6,
